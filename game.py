...
class Game:
    ...
    def generar_sprites(self):
        ...
        self.enemigo = Enemigo(self.grupo_sprites,self.grupo_blas_enemigo,r"recursos\nave_enemiga2.png","recursos\laser.gren.png",97,75,120)
